...
class FoundAdapter(private val mList: ArrayList<ItemsViewModel>) : RecyclerView.Adapter<FoundAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener(View.OnClickListener {
            Intent(holder.itemView.context,Claim::class.java).also {
                it.putExtra("id",id)
